    ...
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('rakit-pc-admin.create') }}" class="bg-brand-600 hover:bg-brand-700 text-white px-4 py-2 rounded-lg font-bold text-sm shadow flex items-center gap-2 transition-colors">
                    ...
                    <table class="w-full text-left text-sm whitespace-nowrap">
                        <thead class="bg-gray-50 text-gray-600 font-semibold text-[11px] uppercase tracking-wider sticky top-0 z-10 shadow-sm">
                            <tr>
                                ...
                                <th class="px-4 py-3 border-b">Harga Estimasi</th>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="{{ route('rakit-pc-admin.edit', $package) }}" class="text-blue-600 hover:text-blue-800 transition-colors p-1.5 bg-blue-50 rounded-lg" title="Edit">
