    ...
    <div class="py-6">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <form action="{{ route('jasa-website-admin.store') }}" method="POST" class="p-6 md:p-8">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div class="md:col-span-2 space-y-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="harga_mulai" id="harga_mulai" value="{{ old('harga_mulai') }}" required min="0" step="1000"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-brand-500"
                            ...
                            <div>
                                ...
                                <textarea name="deskripsi_singkat" id="deskripsi_singkat" rows="3"
                                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-brand-500"
                                          placeholder="Contoh: Landing Page / UMKM">{{ old('deskripsi_singkat') }}</textarea>
