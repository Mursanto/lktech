    ...
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('wifi-voucher-admin.create') }}" class="bg-brand-600 hover:bg-brand-700 text-white px-3 py-1.5 rounded-lg font-bold text-[11px] shadow flex items-center gap-1.5 transition-colors">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-4 py-2 text-right">
                                    <div class="flex items-center justify-end gap-1">
                                        <a href="{{ route('wifi-voucher-admin.edit', $package) }}" class="text-blue-600 hover:text-blue-800 transition-colors p-1 bg-blue-50 hover:bg-blue-100 rounded transition-all" title="Edit">
