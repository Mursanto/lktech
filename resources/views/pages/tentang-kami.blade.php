...
<body class="bg-gray-50 text-gray-800 antialiased flex flex-col min-h-screen">
    ...
    <main class="flex-grow w-full pb-20 md:pb-0">
        ...
        <div class="relative bg-gradient-to-r from-blue-50 via-cyan-50/70 to-emerald-50 py-10 px-4 sm:px-6 lg:px-8 text-center border-b border-cyan-100/70 w-full overflow-hidden">
            ...
            <h1 class="text-2xl md:text-3xl font-black font-montserrat text-blue-900 mb-2 tracking-tight">Kisah LKTech</h1>
            <p class="text-gray-600 text-xs md:text-sm max-w-2xl mx-auto leading-relaxed">Mengenal lebih dekat perjalanan dan komitmen kami untuk Anda.</p>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
            ...
            <section>
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                    ...
                    <div class="lg:col-span-5">
                        <div class="relative">
                            <img src="{{ asset('images/TentangKami.webp') }}"
                                 ...
                                 class="w-full h-auto object-cover rounded-2xl shadow-lg hover:scale-[1.02] transition duration-300">
                    ...
                    <div class="lg:col-span-7">
                        <span class="inline-block bg-brand-50 text-brand-600 text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full border border-brand-100 mb-3">Tentang LKTech</span>
                        <h2 class="text-2xl md:text-3xl font-black text-blue-900 font-montserrat mb-5 leading-tight">Kisah Kami</h2>
            ...
            <section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {{-- Visi Card --}}
                    <div class="bg-gradient-to-br from-blue-50/60 to-slate-50 border border-blue-100 rounded-2xl p-8 shadow-sm hover:-translate-y-1 hover:shadow-md transition duration-300">
            ...
            <section class="pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {{-- Card 1 --}}
                    <div class="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:-translate-y-2 hover:shadow-xl hover:border-emerald-200 transition-all duration-300 group text-center flex flex-col items-center">
                        <div class="w-14 h-14 bg-emerald-50 group-hover:bg-emerald-100 text-emerald-600 rounded-2xl flex items-center justify-center text-2xl mb-4 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-sm">
                            <i class='bx bx-check-shield'></i>
                        </div>
                        <h4 class="font-bold text-gray-900 mb-2 text-base group-hover:text-emerald-700 transition-colors duration-300 font-montserrat">Quality Control Ketat</h4>
                        <p class="text-xs text-gray-500 leading-relaxed">Setiap produk melewati 2 lapis pengujian teknis untuk memastikan performa dan fisik maksimal.</p>
                    </div>
                    {{-- Card 2 --}}
                    <div class="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:-translate-y-2 hover:shadow-xl hover:border-blue-200 transition-all duration-300 group text-center flex flex-col items-center">
                        <div class="w-14 h-14 bg-blue-50 group-hover:bg-blue-100 text-brand-600 rounded-2xl flex items-center justify-center text-2xl mb-4 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-sm">
                            <i class='bx bx-money'></i>
                        </div>
                        <h4 class="font-bold text-gray-900 mb-2 text-base group-hover:text-brand-600 transition-colors duration-300 font-montserrat">Harga Transparan</h4>
                        <p class="text-xs text-gray-500 leading-relaxed">Penawaran harga terbaik dan sangat bersaing di pasaran tanpa adanya biaya tersembunyi.</p>
                    </div>
                    {{-- Card 3 --}}
                    <div class="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:-translate-y-2 hover:shadow-xl hover:border-purple-200 transition-all duration-300 group text-center flex flex-col items-center">
                        <div class="w-14 h-14 bg-purple-50 group-hover:bg-purple-100 text-purple-600 rounded-2xl flex items-center justify-center text-2xl mb-4 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-sm">
                            <i class='bx bx-support'></i>
                        </div>
                        <h4 class="font-bold text-gray-900 mb-2 text-base group-hover:text-purple-600 transition-colors duration-300 font-montserrat">Layanan Purna Jual</h4>
                        <p class="text-xs text-gray-500 leading-relaxed">Dukungan teknisi after-sales yang ramah, cepat tanggap, dan senantiasa siap membantu.</p>
                    </div>
                    {{-- Card 4 --}}
                    <div class="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:-translate-y-2 hover:shadow-xl hover:border-amber-200 transition-all duration-300 group text-center flex flex-col items-center">
                        <div class="w-14 h-14 bg-amber-50 group-hover:bg-amber-100 text-amber-600 rounded-2xl flex items-center justify-center text-2xl mb-4 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-sm">
                            <i class='bx bx-map-pin'></i>
                        </div>
                        <h4 class="font-bold text-gray-900 mb-2 text-base group-hover:text-amber-600 transition-colors duration-300 font-montserrat">Jangkauan Luas</h4>
                        <p class="text-xs text-gray-500 leading-relaxed">Melayani pelanggan di Bogor dan sekitarnya, kini juga siap melayani seluruh wilayah Indonesia.</p>
                    </div>
                </div>
            </section>
