...
<body class="bg-gray-950 text-white antialiased">
    ...
    {{-- ── CTA BOTTOM ── --}}
    <section class="hero-bintang py-12 px-4 text-center relative overflow-hidden">
        <div class="circuit-line absolute top-[40%] left-0 right-0"></div>
        <div class="max-w-2xl mx-auto relative z-10">
            <div class="float-anim inline-block mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-14 h-14 mx-auto" viewBox="0 0 60 60">
            ...
            <p class="text-sm mb-6" style="color:#d1d5db;">Dapatkan harga terbaik untuk scrap PC, laptop, dan komponen elektronik bekas Anda. Proses cepat, transparan, dan ramah lingkungan.</p>
            <a href="https://wa.me/628567354046?text=Halo%20Bintang%2C%20saya%20mau%20jual%20limbah%20elektronik%20saya"
               target="_blank"
               class="cta-pulse glow-emerald inline-flex items-center gap-2 text-white font-black text-base px-8 py-4 rounded-2xl transition-all duration-200"
               style="background:#10b981;">
