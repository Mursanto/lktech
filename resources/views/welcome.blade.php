    ...
    <main class="flex-grow">
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 items-center gap-6 lg:gap-8">
                    ...
                    <div class="md:col-span-7 space-y-4">
                        ...
                        <div class="pt-2 flex flex-wrap gap-3">
                            <a href="{{ route('home', ['all' => 1]) }}#katalog" class="px-5 py-2.5 bg-brand-600 border border-brand-600 text-white font-extrabold rounded-lg shadow-md hover:bg-brand-700 transition text-sm flex items-center gap-2">
                                Lihat Semua Katalog
                            </a>
        ...
        <div id="katalog" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12 flex-shrink-0">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex flex-col group relative">
                    ...
                    <div class="p-1.5 sm:p-2 pt-0 mt-auto">
                        <div class="pt-2 border-t border-gray-100 flex gap-1.5">
                            @php
                                $waText = urlencode("Halo LKTech, saya tertarik dengan unit *{$product->brand} {$product->model_series}* (Rp " . number_format($product->selling_price, 0, ',', '.') . "). Apakah stok masih tersedia?");
