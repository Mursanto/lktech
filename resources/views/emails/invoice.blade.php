...
<body>
    <div class="container">
        <!-- Header -->
        <div style="margin-bottom: 25px; padding: 15px; background-color: #f0fdfa; border: 1px solid #ccfbf1; border-radius: 6px; color: #0f766e;">
            <p style="margin-top: 0; margin-bottom: 8px;"><strong>Halo {{ $sale->customer->name ?? 'Pelanggan' }},</strong></p>
            <p style="margin: 0;">
                @if($sale->payment_status === 'success')
                    Terima kasih telah berbelanja di LKTech. Pembayaran Anda telah kami terima dengan detail sebagai berikut:
                @else
                    Terima kasih telah memesan di LKTech. Berikut adalah tagihan sementara (Proforma Invoice) Anda. Pesanan akan diproses setelah pembayaran lunas.
                @endif
            </p>
        </div>
                    ...
                    <table style="border-collapse: collapse;">
                        <tr>
                            <td style="padding-right: 15px; vertical-align: middle;">
                                ...
                                <img src="{{ asset('images/LKtech.png') }}" alt="LK Tech Logo" onerror="this.style.display='none'" style="max-height: 50px; display: block;">
                            </td>
