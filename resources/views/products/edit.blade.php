                    ...
                    <div class="flex-grow flex flex-col md:flex-row overflow-hidden">
                        ...
                        <div class="w-full md:w-1/2 p-4 md:p-5 overflow-y-auto border-r border-gray-100 scrollbar-hide">
                            ...
                            <div id="inventaris-harga-section">
                                ...
                                {{-- KEPEMILIKAN ASET --}}
                                <div x-data="{ ownerType: '{{ old('ownership_type', $product->ownership_type ?? 'lktech') }}' }" class="mt-3 p-3 bg-violet-50 rounded-xl border border-violet-100">
                                    ...
                                    <div class="flex gap-2 mb-2">
                                        <label class="flex items-center gap-1.5 px-3 py-1.5 border-2 rounded-lg cursor-pointer transition-all text-[11px] font-bold"
                                            ...
                                            <input type="radio" name="ownership_type" value="lktech" x-model="ownerType" class="sr-only">
                                            🏢 Milik LKTech
                                        </label>
                                        <label class="flex items-center gap-1.5 px-3 py-1.5 border-2 rounded-lg cursor-pointer transition-all text-[11px] font-bold"
                                    ...
                                    <div x-show="ownerType === 'investor'" x-transition>
                                        ...
                                        <select name="investor_id" class="w-full px-2 py-1.5 text-xs border border-violet-300 rounded focus:ring-1 focus:ring-violet-500">
                                            ...
                                            <option value="{{ $inv->id }}" {{ old('investor_id', $product->investor_id) == $inv->id ? 'selected' : '' }}>
                        ...
                        <div class="w-full md:w-1/2 p-4 md:p-5 overflow-y-auto bg-gray-50 scrollbar-hide">
                            ...
                            <div class="mb-4 bg-white p-3 rounded-lg border border-fuchsia-100 shadow-sm flex flex-col gap-3">
                                <label class="flex items-start gap-3 cursor-pointer">
                                    <div class="pt-0.5">
                                        <input type="checkbox" name="is_banner_hero" value="1" {{ old('is_banner_hero', $product->is_banner_hero) ? 'checked' : '' }} class="w-4 h-4 text-fuchsia-600 border-gray-300 rounded focus:ring-fuchsia-500">
                                    </div>
                                    <div>
                                ...
                                <label class="flex items-start gap-3 cursor-pointer">
                                    <div class="pt-0.5">
                                        <input type="checkbox" name="is_promo_utama" value="1" {{ old('is_promo_utama', $product->is_promo_utama) ? 'checked' : '' }} class="w-4 h-4 text-red-600 border-gray-300 rounded focus:ring-red-500">
                                    </div>
                                    <div>
